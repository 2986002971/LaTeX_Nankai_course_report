...
%\usepackage{cite}
\usepackage[backend = biber, style = gb7714-2015, defernumbers=true, eventdate=iso, seconds=true]{biblatex}
...
\begin{titlepage}
    ...
    \vspace{10mm}
    {\zihao{1}{\heiti{南开大学XX学院}}}\\[0.8cm]
    {\zihao{1}{\heiti{《XX学》课程报告}}}\\[3cm]
    \vspace{\fill}
